...
type User struct {
	...
	ArtistProfile  artist.ArtistProfile `gorm:"foreignKey:UserID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:SET NULL" json:"artist_profile,omitempty"` // Added relationship
